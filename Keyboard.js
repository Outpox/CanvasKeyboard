    ...
    loadJSON("keyboards/qwerty_uk.json", function (data) {
        ...
        for (var i = 0; i < layout.rows.length; i++) {
            ...
            for (var j = 0; j < layout.rows[i].keys.length; j++) {
                ...
                var startX = line.startX + j * (lengthX + line.spaceX);
                var startY = line.startY + lengthY + line.spaceY;
                var createdKey = new Key(line, startX, startY, lengthX, lengthY, key.content, key.type || "standard");
